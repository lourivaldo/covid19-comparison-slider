...
export default class Slider extends Component {
    ...
    render() {
        return (
            <div className="slider section" id="section-2">

                <div className="container-lg">
                    <h4 className="my-4 text-center">Distribuição Espaço-temporal dos casos confirmados do Coronavirus Covid-19 no Recife</h4>
